...
public:
   ...
   */
    virtual antlrcpp::Any visitProgramme(GramCompParser::ProgrammeContext* context) = 0;
    ...
    virtual antlrcpp::Any visitIncludeCroch(GramCompParser::IncludeCrochContext* context) = 0;

    virtual antlrcpp::Any visitIncludeGuill(GramCompParser::IncludeGuillContext* context) = 0;

    virtual antlrcpp::Any visitFunction_def(GramCompParser::Function_defContext* context) = 0;
