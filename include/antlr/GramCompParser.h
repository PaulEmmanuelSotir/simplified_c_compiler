...
public:
  enum {
    ...
    IDENTIFIER = 39, STRING_LITERAL = 40, CHAR_LITERAL = 41, INTEGER = 42, 
    CHAR = 43, INT32_T = 44, INT64_T = 45
  };

  enum {
    RuleProgramme = 0, RuleInstruction = 1, RuleInclude = 2, RuleFunction = 3, 
    RuleArgs = 4, RuleFunction_init = 5, RuleExpression = 6, RuleStructure = 7, 
    RuleElse_structure = 8, RuleAffectation = 9, RuleDefinition = 10, RuleDeclaration = 11, 
    RuleArray_expr = 12, RuleConst_expr = 13, RuleAtomic_type = 14, RuleType = 15
  };
  ...
  public:
    ...
    IncludeContext() : antlr4::ParserRuleContext() { }
